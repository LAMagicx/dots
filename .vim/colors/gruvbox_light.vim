" -----------------------------------------------------------------------------
" File: gruvbox_light.vim
" Description: Retro groove color scheme for Vim
" Author: morhetz <morhetz@gmail.com>
" Source: https://github.com/morhetz/gruvbox_light
...
if !exists('g:gruvbox_light_bold')
  let g:gruvbox_light_bold=1
endif
if !exists('g:gruvbox_light_italic')
  if has('gui_running') || $TERM_ITALICS == 'true'
    let g:gruvbox_light_italic=1
  else
    let g:gruvbox_light_italic=0
  endif
endif
if !exists('g:gruvbox_light_undercurl')
  let g:gruvbox_light_undercurl=1
endif
if !exists('g:gruvbox_light_underline')
  let g:gruvbox_light_underline=1
endif
if !exists('g:gruvbox_light_inverse')
  let g:gruvbox_light_inverse=1
endif

if !exists('g:gruvbox_light_guisp_fallback') || index(['fg', 'bg'], g:gruvbox_light_guisp_fallback) == -1
  let g:gruvbox_light_guisp_fallback='NONE'
endif

if !exists('g:gruvbox_light_improved_strings')
  let g:gruvbox_light_improved_strings=0
endif

if !exists('g:gruvbox_light_improved_warnings')
  let g:gruvbox_light_improved_warnings=0
endif

if !exists('g:gruvbox_light_termcolors')
  let g:gruvbox_light_termcolors=256
endif

if !exists('g:gruvbox_light_invert_indent_guides')
  let g:gruvbox_light_invert_indent_guides=0
endif

if exists('g:gruvbox_light_contrast')
  echo 'g:gruvbox_light_contrast is deprecated; use g:gruvbox_light_contrast_light and g:gruvbox_light_contrast_dark instead'
endif

if !exists('g:gruvbox_light_contrast_dark')
  let g:gruvbox_light_contrast_dark='medium'
endif

if !exists('g:gruvbox_light_contrast_light')
  let g:gruvbox_light_contrast_light='medium'
endif
...
let s:gb.light0_soft = ['#fbf1c7', 229]     " 253-244-193
let s:gb.light0      = ['#f2e5bc', 228]     " 242-229-188
...
let s:bold = 'bold,'
if g:gruvbox_light_bold == 0
  let s:bold = ''
endif

let s:italic = 'italic,'
if g:gruvbox_light_italic == 0
  let s:italic = ''
endif

let s:underline = 'underline,'
if g:gruvbox_light_underline == 0
  let s:underline = ''
endif

let s:undercurl = 'undercurl,'
if g:gruvbox_light_undercurl == 0
  let s:undercurl = ''
endif

let s:inverse = 'inverse,'
if g:gruvbox_light_inverse == 0
  let s:inverse = ''
endif
...
if g:gruvbox_light_contrast_light == 'soft'
  let s:bg0  = s:gb.light0_soft
elseif g:gruvbox_light_contrast_light == 'hard'
...
if g:gruvbox_light_termcolors == 16
  let s:bg0[1]    = 0
  let s:fg4[1]    = 7
  let s:gray[1]   = 8
  let s:red[1]    = 9
...
if exists('g:gruvbox_light_hls_cursor')
  let s:hls_cursor = get(s:gb, g:gruvbox_light_hls_cursor)
endif

let s:number_column = s:none
if exists('g:gruvbox_light_number_column')
  let s:number_column = get(s:gb, g:gruvbox_light_number_column)
endif
...
if exists('g:gitgutter_override_sign_column_highlight') &&
  ...
  if exists('g:gruvbox_light_sign_column')
    let s:sign_column = get(s:gb, g:gruvbox_light_sign_column)
  endif
endif

let s:color_column = s:bg1
if exists('g:gruvbox_light_color_column')
  let s:color_column = get(s:gb, g:gruvbox_light_color_column)
endif

let s:vert_split = s:bg0
if exists('g:gruvbox_light_vert_split')
  let s:vert_split = get(s:gb, g:gruvbox_light_vert_split)
endif

let s:invert_signs = ''
if exists('g:gruvbox_light_invert_signs')
  if g:gruvbox_light_invert_signs == 1
    let s:invert_signs = s:inverse
  endif
endif

let s:invert_selection = s:inverse
if exists('g:gruvbox_light_invert_selection')
  if g:gruvbox_light_invert_selection == 0
    let s:invert_selection = ''
  endif
endif

let s:invert_tabline = ''
if exists('g:gruvbox_light_invert_tabline')
  if g:gruvbox_light_invert_tabline == 1
    let s:invert_tabline = s:inverse
  endif
endif

let s:italicize_comments = s:italic
if exists('g:gruvbox_light_italicize_comments')
  if g:gruvbox_light_italicize_comments == 0
    let s:italicize_comments = ''
  endif
endif

let s:italicize_strings = ''
if exists('g:gruvbox_light_italicize_strings')
  if g:gruvbox_light_italicize_strings == 1
...
function! s:HL(group, fg, ...)
  ...
  " special fallback
  if a:0 >= 3
    if g:gruvbox_light_guisp_fallback != 'NONE'
      let fg = a:3
    endif

    " bg fallback mode should invert higlighting
    if g:gruvbox_light_guisp_fallback == 'bg'
      let emstr .= 'inverse,'
    endif
  endif
...
" --- https://github.com/morhetz/gruvbox_light/issues/7
if s:is_dark
  set background=dark
else
...
if g:gruvbox_light_improved_strings == 0
...
if has("spell")
  ...
  if g:gruvbox_light_improved_warnings == 0
...
if g:indent_guides_auto_colors == 0
  if g:gruvbox_light_invert_indent_guides == 0
...
" vim: set sw=2 ts=2 sts=2 et tw=80 ft=vim foldmethod=marker:
